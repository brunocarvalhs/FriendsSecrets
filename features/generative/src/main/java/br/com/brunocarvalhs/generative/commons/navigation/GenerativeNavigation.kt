package br.com.brunocarvalhs.generative.commons.navigation
...
fun NavGraphBuilder.generativeGraph(
    ...
    navigation(startDestination = GenerativeNavigation.START_DESTINATION, route = route) {
        composable(GenerativeNavigation.Chat.route) {
            ...
            val viewModel: br.com.brunocarvalhs.generative.app.chat.ChatGenerativeViewModel =
                viewModel(factory = br.com.brunocarvalhs.generative.app.chat.ChatGenerativeViewModel.Factory)

            br.com.brunocarvalhs.generative.app.chat.ChatGenerativeScreen(
                data = data,
